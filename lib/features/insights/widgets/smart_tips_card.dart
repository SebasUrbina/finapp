...
class _TipItem extends StatelessWidget {
  ...
  _TipConfig _getTipConfig(SmartTipType type) {
    switch (type) {
      case SmartTipType.warning:
        return _TipConfig(
          color: const Color(0xFFFF6B6B),
          defaultIcon: Icons.warning_rounded,
        );
      case SmartTipType.success:
        return _TipConfig(
          color: const Color(0xFF4CAF50),
          defaultIcon: Icons.check_circle_rounded,
        );
      case SmartTipType.info:
        return _TipConfig(
          color: const Color(0xFF42A5F5),
          defaultIcon: Icons.info_rounded,
        );
      case SmartTipType.suggestion:
        return _TipConfig(
  ...
  IconData? _getIcon(IconType? iconType) {
    ...
    switch (iconType) {
      case IconType.trendUp:
        return Icons.trending_up_rounded;
      case IconType.trendDown:
